...
func (*Backup) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_a4f45ac0e4b15a8b, []int{0}
}
...
func init() {
	proto.RegisterFile("yandex/cloud/mdb/mongodb/v1/backup.proto", fileDescriptor_backup_a4f45ac0e4b15a8b)
}

var fileDescriptor_backup_a4f45ac0e4b15a8b = []byte{
