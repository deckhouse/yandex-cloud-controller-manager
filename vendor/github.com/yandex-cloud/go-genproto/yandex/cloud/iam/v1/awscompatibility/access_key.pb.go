...
func (*AccessKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_access_key_4b7e8a0d48d61421, []int{0}
}
...
func init() {
	proto.RegisterFile("yandex/cloud/iam/v1/awscompatibility/access_key.proto", fileDescriptor_access_key_4b7e8a0d48d61421)
}

var fileDescriptor_access_key_4b7e8a0d48d61421 = []byte{
