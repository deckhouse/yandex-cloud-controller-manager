...
func (*UserAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_user_account_1a28e7bc8da60c3e, []int{0}
}
...
// A YandexPassportUserAccount resource. For more information, see [Passport users](/docs/iam/concepts/users/users#passport).
...
func (*YandexPassportUserAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_user_account_1a28e7bc8da60c3e, []int{1}
}
...
func init() {
	proto.RegisterFile("yandex/cloud/iam/v1/user_account.proto", fileDescriptor_user_account_1a28e7bc8da60c3e)
}

var fileDescriptor_user_account_1a28e7bc8da60c3e = []byte{
